...
#	fi
	...
	# change path to raw genomes if no polishing + perform a samtools readmapping on the raw genomes...
	# create a folder named BestAssembly in which the best assembly should be placed manually
	conda deactivate
fi