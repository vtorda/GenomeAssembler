...
then
	...
	# copy samtools stat files into one folder and just refer to that folder in multiqc...
	# copy busco short_summary... files too into separate folder
	#copy quast report tsv too...
fi