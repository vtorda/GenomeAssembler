...
then
	...
	mkdir -p $out1
	spades.py --only-assembler $spades_polish -t $Threads --pe1-1 ${INPUT}/*Paired_1.fastq.gz --pe1-2 ${INPUT}/*Paired_2.fastq.gz --pe1-s ${INPUT}/*Single_1.fastq.gz --pe2-s ${INPUT}/*Single_2.fastq.gz -o $out1 > ${out1}/Spades.log 2> ${out1}/Spades.elog
...
then
	...
	mkdir -p $out_meta
	spades.py --meta --only-assembler -t $Threads --pe1-1 ${INPUT}/*Paired_1.fastq.gz --pe1-2 ${INPUT}/*Paired_2.fastq.gz --pe1-s ${INPUT}/*Single_1.fastq.gz --pe2-s ${INPUT}/*Single_2.fastq.gz -o $out_meta > ${out_meta}/Spades.log 2> ${out_meta}/Spades.elog
