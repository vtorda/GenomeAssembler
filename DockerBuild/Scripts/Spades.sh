...
then
	...
	mkdir -p $out1
	spades.py --only-assembler --careful -t $Threads --pe1-1 ${INPUT}/*Paired_1.fastq.gz --pe1-2 ${INPUT}/*Paired_2.fastq.gz --pe1-s ${INPUT}/*Single_1.fastq.gz --pe2-s ${INPUT}/*Single_2.fastq.gz -o $out1 > ${out1}/Spades.log 2> ${out1}/Spades.elog
