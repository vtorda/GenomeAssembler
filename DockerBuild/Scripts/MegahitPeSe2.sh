...
then
	...
	megahit --no-mercy --min-count 3 --k-list 31,51,71,91,99 -t $Threads -1 ${INPUT}/*Paired_1.fastq.gz -2 ${INPUT}/*Paired_2.fastq.gz \
...
then
	...
	single1=$(ls -d ${INPUT}/*Single_1.fastq.gz)
	single2=$(ls -d ${INPUT}/*Single_2.fastq.gz)
	megahit --min-count 2 --k-list 21,31,41,51,61,71,81,91,99 -t $Threads -1 ${INPUT}/*Paired_1.fastq.gz -2 ${INPUT}/*Paired_2.fastq.gz \
